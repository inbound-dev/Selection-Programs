...
// These are constants that are used in calculation        
        double labour = 0.75;
        double rent = 0.99;
        double diameters = 0.50;
        
//getting user input for diameter of pizza
        double p1 = Double.parseDouble(diameter.getText());
        
        double p2 =  p1 * diameters; 
        
//calculating price tax etc.
        
        double price = (p2 + labour + rent);
        double tax  = 13 * price/100;
        double prices = tax + price;
        
// telling the customer the total of all values taxes etc.       
